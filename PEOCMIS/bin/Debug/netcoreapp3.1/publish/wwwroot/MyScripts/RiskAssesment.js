...
function PopulateTable(result) {
    ...
    for (var i = 0; i < result.length; i++) {
        ...
        rows += "<td  style='font-weight: bold'>" + index +
            ...
            "<td>" + result[i].title +
            "<td>" + result[i].detail +
            "<td><img id='timg' name='timg'  src='/pdmamadadgar/DisasterImages/" + result[i].imageName+"'  style='background-size: contain; background-repeat: no-repeat; background-position: center; max-width:350px;  max-height:200px;'/>"
